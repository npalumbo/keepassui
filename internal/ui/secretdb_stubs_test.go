...
func secretsDBWithTwoGroups() secretsdb.SecretsDB {
	...
	secretsGroupedByPath["path 1|path 2"] = []secretsdb.SecretEntry{
		{Title: "title 2", Group: "path 1|path 2", Username: "username 2", Password: "password 2", Url: "url 2", Notes: "notes 2"},
		{Title: "title 3", Group: "path 1|path 2", Username: "username 3", Password: "password 3", Url: "url 3", Notes: "notes 3"},
	}
	paths := []string{"path 1", "path 1|path 2"}
	secretsDB := secretsdb.SecretsDB{
		EntriesByPath: secretsGroupedByPath,
		PathsInOrder:  paths,
	}
